...
var utils_1 = require("@0x/utils"); // uses bignumber.js under the hood
...
var WyvernProtocol = /** @class */ (function () {
    function WyvernProtocol(ethersSigner, config) {
     ...
     */
    WyvernProtocol.prototype.setProvider = function (provider) {
        this.setSigner(this._ethersSigner.connect(provider));
    };
    WyvernProtocol.prototype.setSigner = function (signer) {
        this._ethersSigner = signer; // will this work? signer doesn't seem to be stateful?
        this.connectContracts(this._config);
    };
    WyvernProtocol.prototype.connectContracts = function (config) {
        var exchangeContractAddress = config.wyvernExchangeContractAddress ||
            WyvernProtocol.getExchangeContractAddress(config.network);
        this.wyvernExchange = new wyvern_exchange_1.WyvernExchangeContract(new ethers_1.ethers.Contract(exchangeContractAddress, constants_1.constants.EXCHANGE_ABI, this._ethersSigner), {});
        ...
        this.wyvernProxyRegistry = new wyvern_proxy_registry_1.WyvernProxyRegistryContract(new ethers_1.ethers.Contract(proxyRegistryContractAddress, constants_1.constants.PROXY_REGISTRY_ABI, this._ethersSigner), {});
        var daoContractAddress = config.wyvernDAOContractAddress ||
            WyvernProtocol.getDAOContractAddress(config.network);
        this.wyvernDAO = new wyvern_d_a_o_1.WyvernDAOContract(new ethers_1.ethers.Contract(daoContractAddress, constants_1.constants.DAO_ABI, this._ethersSigner), {});
        var tokenContractAddress = config.wyvernTokenContractAddress ||
            WyvernProtocol.getTokenContractAddress(config.network);
        this.wyvernToken = new wyvern_token_1.WyvernTokenContract(new ethers_1.ethers.Contract(tokenContractAddress, constants_1.constants.TOKEN_ABI, this._ethersSigner), {});
        ...
        this.wyvernAtomicizer = new wyvern_atomicizer_1.WyvernAtomicizerContract(new ethers_1.ethers.Contract(atomicizerContractAddress, constants_1.constants.ATOMICIZER_ABI, this._ethersSigner), {});
    };
    /**
    ...
    WyvernProtocol.prototype.getAvailableAddressesAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._ethersSigner.getAddress()];
                    case 1:
                        availableAddresses = _a.sent();
                        return [2 /*return*/, [availableAddresses]]; // workaround for now. TODO: can possibly implement other detection methods to get array of signers for other ethers signers
                }
            });
        });
    };
