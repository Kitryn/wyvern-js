...
var WyvernAtomicizerContract = /** @class */ (function (_super) {
    ...
    function WyvernAtomicizerContract(ethersContractInstance, defaults) {
        ...
        _this.atomicize = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                ethersInputs = self.convertEthersInputs(addrs_0, values_1, calldataLengths_2, calldatas_3);
                                return [4 /*yield*/, (_a = self.ethersContractInstance).atomicize.apply(_a, __spreadArray(__spreadArray([], ethersInputs), [ethersTxData]))];
                            case 2:
                                txResponse = _b.sent();
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                ethersTxData = utils_1.utils.convertTxDataToEthers(txDataWithDefaults);
                                ethersInputs = self.convertEthersInputs(addrs_0, values_1, calldataLengths_2, calldatas_3);
                                return [4 /*yield*/, (_a = self.ethersContractInstance.estimateGas).atomicize.apply(_a, __spreadArray(__spreadArray([], ethersInputs), [ethersTxData]))];
                            case 2:
                                gas = _b.sent();
            ...
            getABIEncodedTransactionData: function (addrs_0, values_1, calldataLengths_2, calldatas_3) {
                var self = this;
                var ethersInputs = self.convertEthersInputs(addrs_0, values_1, calldataLengths_2, calldatas_3);
                var abiEncodedTransactionData = self.ethersContractInstance.interface.encodeFunctionData("atomicize", __spreadArray([], ethersInputs));
