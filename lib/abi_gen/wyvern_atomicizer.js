    ...
    function WyvernAtomicizerContract(ethersContractInstance, defaults) {
        ...
        _this.atomicize = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, self.ethersContractInstance.atomicize(addrs_0, values_1, calldataLengths_2, calldatas_3, txDataWithDefaults)];
                            case 2:
                                txResponse = _a.sent();
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, self.ethersContractInstance.estimateGas.atomicize(addrs_0, values_1, calldataLengths_2, calldatas_3, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
            ...
            getABIEncodedTransactionData: function (addrs_0, values_1, calldataLengths_2, calldatas_3) {
                var self = this;
                var abiEncodedTransactionData = self.ethersContractInstance.interface.encodeFunctionData("atomicize", [
                    addrs_0,
                    values_1,
                    calldataLengths_2,
                    calldatas_3,
